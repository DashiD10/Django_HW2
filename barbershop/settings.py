...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Администрирование Барбершопа",
    
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Барбершоп Админ",
    ...
    "welcome_sign": "Добро пожаловать в административную панель барбершопа",
    ...
    "order_with_respect_to": ["auth", "core", "books", "main"],
    ...
    "icons": {
        ...
        "core": "fas fa-cut",
        "core.Order": "fas fa-calendar-check",
        "core.Master": "fas fa-user-tie",
